...
This document defines the threat model for DarkSight, including adversary capabilities, attack surfaces, and security assumptions.
...
Given the threat model above, DarkSight provides:
