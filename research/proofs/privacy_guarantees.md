...
DarkSight provides privacy guarantees through a combination of zero-knowledge proofs, synthetic activity generation, and temporal mixing. This document formalizes the privacy properties of the protocol.
...
For DarkSight, `ρ ≥ 1.0` ensures that synthetic activity always exceeds real activity, providing cover traffic even for the first user.
