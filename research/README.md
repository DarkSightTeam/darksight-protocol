...
Mathematical foundations, security analysis, and formal specifications for the DarkSight privacy-preserving prediction market protocol.

## Overview

This repository contains the theoretical foundations and security analysis for DarkSight, a privacy-preserving prediction market protocol built on Solana using zero-knowledge proofs.
