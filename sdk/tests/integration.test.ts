 ...
 * Integration Tests
 * 
 * End-to-end tests for complete DarkSight protocol flows
 */

import { DarkSightSDK } from '../src/sdk';
...
describe('DarkSight Integration Tests', () => {
    let sdk: DarkSightSDK;
    let merkleTree: MerkleTree;

    beforeEach(async () => {
        sdk = new DarkSightSDK({
    ...
    describe('Error Handling', () => {
        it('should handle SDK initialization errors', async () => {
            const uninitializedSDK = new DarkSightSDK({
                connection: mockConnection,
                wallet: mockWallet,
                network: 'devnet',
            });
